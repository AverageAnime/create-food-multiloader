package dev.averageanime.menu.type.block;
...
public abstract class ClothSackBlockMenu extends AbstractContainerMenu {

    protected final ClothSackBlockEntity blockEntity;

    protected ClothSackBlockMenu(MenuType<?> type, int id,
