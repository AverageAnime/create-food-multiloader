...
public class SmallBowlFoodBlock extends DisplayFoodBlock {
    protected static final VoxelShape SHAPE = Block.box(4, 0.0, 4, 12, 2, 12);

    public SmallBowlFoodBlock(Supplier<Item> displayItem) {
    ...
    protected void handleLastItemEaten(BlockState state, Level level, BlockPos pos) {
        Block emptySmallBowl = Services.PLATFORM.getSmallBowlBlock();
        BlockState emptyState = emptySmallBowl.defaultBlockState();
