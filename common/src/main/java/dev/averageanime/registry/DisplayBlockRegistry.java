 ...
 * <p>
 * Holds the shared pattern→config map, exclusion sets, and lookup helpers so that
 * both NeoForge and Fabric {@code ModDisplayBlocks} can share this data without duplication.
 * Platform-specific code is still responsible for the actual block/item registration.
 */
public final class DisplayBlockRegistry {
    ...
    static {
        ...
        put(m, "hot_chocolate_bottle",          DisplayType.BOTTLE, 8, true,  () -> ParticleTypes.WHITE_SMOKE);
        ...
        put(m, "soup_bowl",                     DisplayType.BOWL,  4,   true,  () -> ParticleTypes.WHITE_SMOKE);
        put(m, "stew_bowl",                     DisplayType.BOWL,  4,   true,  () -> ParticleTypes.WHITE_SMOKE);
