...
import net.averageanime.createfood.config.ClothConfigSetup;
...
public class CreateFood {
    ...
    public CreateFood() {
        ...
        FluidEntry.registerAll(modEventBus);
        ModFluids.register();
    ...
    public static class ClientEvents {
        ...
        public static void onClientSetup(FMLClientSetupEvent event) {
            ...
            event.enqueueWork(() -> {
                ...
                setTranslucent(ModFluids.APPLE_JUICE);
                setTranslucent(ModFluids.BERRY_JUICE);
                setTranslucent(ModFluids.BLACK_GELATIN_MIX);
                setTranslucent(ModFluids.BLUE_GELATIN_MIX);
                setTranslucent(ModFluids.BROWN_GELATIN_MIX);
                setTranslucent(ModFluids.CHORUS_FRUIT_JUICE);
                setTranslucent(ModFluids.CYAN_GELATIN_MIX);
                setTranslucent(ModFluids.GELATIN_MIX);
                setTranslucent(ModFluids.GLOW_BERRY_JUICE);
                setTranslucent(ModFluids.GRAY_GELATIN_MIX);
                setTranslucent(ModFluids.GREEN_GELATIN_MIX);
                setTranslucent(ModFluids.LIGHT_BLUE_GELATIN_MIX);
                setTranslucent(ModFluids.LIGHT_GRAY_GELATIN_MIX);
                setTranslucent(ModFluids.LIME_GELATIN_MIX);
                setTranslucent(ModFluids.MAGENTA_GELATIN_MIX);
                setTranslucent(ModFluids.ORANGE_GELATIN_MIX);
                setTranslucent(ModFluids.PINK_GELATIN_MIX);
                setTranslucent(ModFluids.PURPLE_GELATIN_MIX);
                setTranslucent(ModFluids.RED_GELATIN_MIX);
                setTranslucent(ModFluids.SQUID_INK);
                setTranslucent(ModFluids.VEGETABLE_OIL);
                setTranslucent(ModFluids.VINEGAR);
                setTranslucent(ModFluids.YELLOW_GELATIN_MIX);
            });
        }
        ...
        private static void setTranslucent(FluidEntry.Type entry) {
