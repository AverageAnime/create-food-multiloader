...
public class ModFluids {
    ...
    public static void registerFluid(){
        ...
        if (CONFIG.isPumpkinPieFillingFluidEnabled) {
            ItemGroupEvents.modifyEntriesEvent(CreateFood.GROUP).register(entries -> entries.add(PUMPKIN_PIE_FILLING_BUCKET));
            STILL_PUMPKIN_PIE_FILLING = Registry.register(Registries.FLUID,
                    new Identifier(CreateFood.MOD_ID, "pumpkin_pie_filling"), new PumpkinPieFillingFluid.Still());
            FLOWING_PUMPKIN_PIE_FILLING = Registry.register(Registries.FLUID,
                    new Identifier(CreateFood.MOD_ID, "flowing_pumpkin_pie_filling"), new PumpkinPieFillingFluid.Flowing());
            PUMPKIN_PIE_FILLING_BLOCK = Registry.register(Registries.BLOCK, new Identifier(CreateFood.MOD_ID, "pumpkin_pie_filling_block"),
                    new FluidBlock(ModFluids.STILL_PUMPKIN_PIE_FILLING, FabricBlockSettings.copyOf(Blocks.WATER)) {
                    });
            PUMPKIN_PIE_FILLING_BUCKET = Registry.register(Registries.ITEM, new Identifier(CreateFood.MOD_ID, "pumpkin_pie_filling_bucket"),
                    new BucketItem(ModFluids.STILL_PUMPKIN_PIE_FILLING, new FabricItemSettings().recipeRemainder(Items.BUCKET).maxCount(1)));
        }
        if (CONFIG.isPumpkinPureeFluidEnabled) {
            ItemGroupEvents.modifyEntriesEvent(CreateFood.GROUP).register(entries -> entries.add(PUMPKIN_PUREE_BUCKET));
            STILL_PUMPKIN_PUREE = Registry.register(Registries.FLUID,
                    new Identifier(CreateFood.MOD_ID, "pumpkin_puree"), new PumpkinPureeFluid.Still());
            FLOWING_PUMPKIN_PUREE = Registry.register(Registries.FLUID,
                    new Identifier(CreateFood.MOD_ID, "flowing_pumpkin_puree"), new PumpkinPureeFluid.Flowing());
            PUMPKIN_PUREE_BLOCK = Registry.register(Registries.BLOCK, new Identifier(CreateFood.MOD_ID, "pumpkin_puree_block"),
                    new FluidBlock(ModFluids.STILL_PUMPKIN_PUREE, FabricBlockSettings.copyOf(Blocks.WATER)) {
                    });
            PUMPKIN_PUREE_BUCKET = Registry.register(Registries.ITEM, new Identifier(CreateFood.MOD_ID, "pumpkin_puree_bucket"),
                    new BucketItem(ModFluids.STILL_PUMPKIN_PUREE, new FabricItemSettings().recipeRemainder(Items.BUCKET).maxCount(1)));
        }
