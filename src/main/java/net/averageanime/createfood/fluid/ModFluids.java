...
public class ModFluids {
    ...
    public static final FluidEntry<ForgeFlowingFluid.Flowing> MOLTEN_ANDESITE =
            REGISTRATE.standardFluid("molten_andesite",
                            SolidRenderedPlaceableFluidType.create(0x5f5f5f,
                                    () -> 1f / 32f * 1))
