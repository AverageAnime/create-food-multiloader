...
public class ChocolatePieGrahamCrackerBlock extends ModPieBlock {
    ...
    public ItemStack getPieSliceItem() {
        return new ItemStack(ModItems.CHOCOLATE_PIE_GRAHAM_CRACKER_SLICE.get());
    }
