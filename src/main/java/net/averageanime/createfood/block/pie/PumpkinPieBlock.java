...
public class PumpkinPieBlock extends ModPieBlock {

    public PumpkinPieBlock(Properties pProperties) {
        super(pProperties);
    }

    @Override
    public ItemStack getPieSliceItem() {
        return new ItemStack(ModItems.PUMPKIN_PIE_SLICE.get());
    }
    ...
    protected InteractionResult consumeBite(LevelAccessor pLevel, BlockPos pPos, BlockState pState, Player pPlayer) {
        ...
        pPlayer.getFoodData().eat(3, 1.0F);
