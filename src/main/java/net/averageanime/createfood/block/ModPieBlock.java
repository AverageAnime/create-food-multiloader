...
public class ModPieBlock extends PieBlock {
    ...
    public ModPieBlock(Item pieSlice) {
        super(pieSlice);
    ...
    static {
        BITES_TO_SHAPE = new VoxelShape[]{
                ...
                VoxelShapes.union(
                        Block.createCuboidShape(2.0D, 0.0D, 8.0D, 8.0D, 4.0D, 14.0D),
                        Block.createCuboidShape(2.0D, 0.0D, 2.0D, 14.0D, 4.0D, 8.0D)
                ),
                Block.createCuboidShape(2.0D, 0.0D, 2.0D, 14.0D, 4.0D, 8.0D),
                Block.createCuboidShape(8.0D, 0.0D, 2.0D, 14.0D, 4.0D, 8.0D)
        };
    }
}