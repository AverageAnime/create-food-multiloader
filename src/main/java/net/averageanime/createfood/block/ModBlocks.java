...
// Raw Pumpkin Pie
        ...
        if (CONFIG.isRawPumpkinPieEnabled) {
            RAW_PUMPKIN_PIE = registerBlock("raw_pumpkin_pie", new RawPieBlock(FabricBlockSettings.copyOf(WHITE_CARPET).nonOpaque()));
            ItemGroupEvents.modifyEntriesEvent(CreateFood.GROUP).register(entries -> entries.add(RAW_PUMPKIN_PIE));
        }
