...
public class ClothSackRenderer<T extends ClothSackBlockEntity> implements BlockEntityRenderer<T> {
    ...
    public void render(@NotNull T be, float partialTick,
        ...
        if (CreateFoodConfig.CLIENT == null || !CreateFoodConfig.CLIENT.showSackBlockIcons.get()) return;
        ...
        for (int i = 0; i < 4; i++) {
            ItemStack stack = be.inventory.getInventoryItem(i);
