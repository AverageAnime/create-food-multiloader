...
public class ClothSackMenu extends AbstractContainerMenu {
    ...
    public ClothSackMenu(int containerId, Inventory playerInventory, ClothSackBlockEntity blockEntity) {
        ...
        addSlot(new SlotItemHandler(blockEntity.inventory, 0, 71, 25));
        addSlot(new SlotItemHandler(blockEntity.inventory, 1, 89, 25));
        addSlot(new SlotItemHandler(blockEntity.inventory, 2, 71, 43));
        addSlot(new SlotItemHandler(blockEntity.inventory, 3, 89, 43));
