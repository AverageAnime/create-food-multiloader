...
import dev.averageanime.neoforge.block.type.blockentity.GenericDisplayPlateBlockEntity;
...
public class ModBlockEntities {
    ...
    @SuppressWarnings("DataFlowIssue")
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<GenericDisplayPlateBlockEntity>>
        GENERIC_DISPLAY_PLATE = BLOCK_ENTITIES.register("generic_display_plate",
            () -> BlockEntityType.Builder
                .of(GenericDisplayPlateBlockEntity::new, ModDisplayBlocks.GENERIC_DISPLAY_PLATE_BLOCK.get())
                .build(null));
