...
public class ModBlocks {
    ...
    private record Tip(String compat, String[] keys) {}

    /**
     * Build a {@link Tip}. The compat key is SHORT — the {@code tooltip.compat.}
     * prefix is added automatically — or {@code null}. Ingredient keys are also
     * SHORT — the {@code tooltip.createfood.} prefix is added automatically.
     *
     * <pre>{@code
     * tips(null, "bacon_ingredient", "cheese_ingredient")
     * tips("ube", "ube_cream_frosting_ingredient")
     * }</pre>
     */
    ...
    private static DeferredBlock<Block> registerCookedPie(String name,
                                                          Supplier<Item> sliceItem,
                                                          Tip tip) {
        Supplier<Block> blockSupplier = () -> new PieBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.CAKE), sliceItem);
        if (tip != null) return registerBlockWithTooltips(name, blockSupplier, tip);
        return registerBlock(name, blockSupplier);
    }
    ...
    public static final DeferredBlock<Block> APPLE_CREAM_CAKE = registerCake("apple_cream_cake", ModItems.APPLE_CREAM_CAKE_SLICE, 1, tips(null, "apple_cream_frosting_ingredient"));
    ...
    public static final DeferredBlock<Block> BERRY_CREAM_CAKE = registerCake("berry_cream_cake", ModItems.BERRY_CREAM_CAKE_SLICE, 1, tips(null, "berry_cream_frosting_ingredient"));
    public static final DeferredBlock<Block> BERRY_CREAM_CAKE_CHORUS_FRUIT = registerCake("berry_cream_cake_chorus_fruit", ModItems.BERRY_CREAM_CAKE_SLICE_CHORUS_FRUIT, 1, tips(null, "berry_cream_frosting_ingredient", "chorus_fruit_ingredient"));
    public static final DeferredBlock<Block> BERRY_CREAM_CAKE_GLOW_BERRY = registerCake("berry_cream_cake_glow_berry", ModItems.BERRY_CREAM_CAKE_SLICE_GLOW_BERRY, 1, tips(null, "berry_cream_frosting_ingredient", "glow_berry_ingredient"));
    public static final DeferredBlock<Block> BERRY_CREAM_CAKE_SWEET_BERRY = registerCake("berry_cream_cake_sweet_berry", ModItems.BERRY_CREAM_CAKE_SLICE_SWEET_BERRY, 1, tips(null, "berry_cream_frosting_ingredient", "berry_ingredient"));
    ...
    public static final DeferredBlock<Block> CHOCOLATE_CREAM_CAKE = registerCake("chocolate_cream_cake", ModItems.CHOCOLATE_CREAM_CAKE_SLICE, 1, tips(null, "chocolate_cream_frosting_ingredient"));
    public static final DeferredBlock<Block> CHOCOLATE_CREAM_CAKE_BUTTERSCOTCH = registerCake("chocolate_cream_cake_butterscotch", ModItems.CHOCOLATE_CREAM_CAKE_SLICE_BUTTERSCOTCH, 1, tips(null, "chocolate_cream_frosting_ingredient", "butterscotch_chips_ingredient"));
    public static final DeferredBlock<Block> CHOCOLATE_CREAM_CAKE_CARAMEL = registerCake("chocolate_cream_cake_caramel", ModItems.CHOCOLATE_CREAM_CAKE_SLICE_CARAMEL, 1, tips(null, "chocolate_cream_frosting_ingredient", "caramel_chips_ingredient"));
    public static final DeferredBlock<Block> CHOCOLATE_CREAM_CAKE_CHOCOLATE = registerCake("chocolate_cream_cake_chocolate", ModItems.CHOCOLATE_CREAM_CAKE_SLICE_CHOCOLATE, 1, tips(null, "chocolate_cream_frosting_ingredient", "chocolate_chips_ingredient"));
    public static final DeferredBlock<Block> CHOCOLATE_CREAM_CAKE_DARK_CHOCOLATE = registerCake("chocolate_cream_cake_dark_chocolate", ModItems.CHOCOLATE_CREAM_CAKE_SLICE_DARK_CHOCOLATE, 1, tips(null, "chocolate_cream_frosting_ingredient", "dark_chocolate_chips_ingredient"));
    public static final DeferredBlock<Block> CHOCOLATE_CREAM_CAKE_TOFFEE = registerCake("chocolate_cream_cake_toffee", ModItems.CHOCOLATE_CREAM_CAKE_SLICE_TOFFEE, 1, tips(null, "chocolate_cream_frosting_ingredient", "toffee_chips_ingredient"));
    public static final DeferredBlock<Block> CHOCOLATE_CREAM_CAKE_WHITE_CHOCOLATE = registerCake("chocolate_cream_cake_white_chocolate", ModItems.CHOCOLATE_CREAM_CAKE_SLICE_WHITE_CHOCOLATE, 1, tips(null, "chocolate_cream_frosting_ingredient", "white_chocolate_chips_ingredient"));
    ...
    public static final DeferredBlock<Block> CHORUS_FRUIT_CREAM_CAKE = registerCake("chorus_fruit_cream_cake", ModItems.CHORUS_FRUIT_CREAM_CAKE_SLICE, 1, tips(null, "chorus_fruit_cream_frosting_ingredient"));
    public static final DeferredBlock<Block> CHORUS_FRUIT_CREAM_CAKE_CHORUS_FRUIT = registerCake("chorus_fruit_cream_cake_chorus_fruit", ModItems.CHORUS_FRUIT_CREAM_CAKE_SLICE_CHORUS_FRUIT, 1, tips(null, "chorus_fruit_cream_frosting_ingredient", "chorus_fruit_ingredient"));
    public static final DeferredBlock<Block> CHORUS_FRUIT_CREAM_CAKE_GLOW_BERRY = registerCake("chorus_fruit_cream_cake_glow_berry", ModItems.CHORUS_FRUIT_CREAM_CAKE_SLICE_GLOW_BERRY, 1, tips(null, "chorus_fruit_cream_frosting_ingredient", "glow_berry_ingredient"));
    public static final DeferredBlock<Block> CHORUS_FRUIT_CREAM_CAKE_SWEET_BERRY = registerCake("chorus_fruit_cream_cake_sweet_berry", ModItems.CHORUS_FRUIT_CREAM_CAKE_SLICE_SWEET_BERRY, 1, tips(null, "chorus_fruit_cream_frosting_ingredient", "berry_ingredient"));
    ...
    public static final DeferredBlock<Block> CREAM_CAKE = registerCake("cream_cake", ModItems.CREAM_CAKE_SLICE, 1, tips(null, "cream_frosting_ingredient"));
    public static final DeferredBlock<Block> CREAM_CAKE_CHORUS_FRUIT = registerCake("cream_cake_chorus_fruit", ModItems.CREAM_CAKE_SLICE_CHORUS_FRUIT, 1, tips(null, "cream_frosting_ingredient", "chorus_fruit_ingredient"));
    public static final DeferredBlock<Block> CREAM_CAKE_GLOW_BERRY = registerCake("cream_cake_glow_berry", ModItems.CREAM_CAKE_SLICE_GLOW_BERRY, 1, tips(null, "cream_frosting_ingredient", "glow_berry_ingredient"));
    ...
    public static final DeferredBlock<Block> GLOW_BERRY_CREAM_CAKE = registerCake("glow_berry_cream_cake", ModItems.GLOW_BERRY_CREAM_CAKE_SLICE, 1, tips(null, "glow_berry_cream_frosting_ingredient"));
    public static final DeferredBlock<Block> GLOW_BERRY_CREAM_CAKE_CHORUS_FRUIT = registerCake("glow_berry_cream_cake_chorus_fruit", ModItems.GLOW_BERRY_CREAM_CAKE_SLICE_CHORUS_FRUIT, 1, tips(null, "glow_berry_cream_frosting_ingredient", "chorus_fruit_ingredient"));
    public static final DeferredBlock<Block> GLOW_BERRY_CREAM_CAKE_GLOW_BERRY = registerCake("glow_berry_cream_cake_glow_berry", ModItems.GLOW_BERRY_CREAM_CAKE_SLICE_GLOW_BERRY, 1, tips(null, "glow_berry_cream_frosting_ingredient", "glow_berry_ingredient"));
    public static final DeferredBlock<Block> GLOW_BERRY_CREAM_CAKE_SWEET_BERRY = registerCake("glow_berry_cream_cake_sweet_berry", ModItems.GLOW_BERRY_CREAM_CAKE_SLICE_SWEET_BERRY, 1, tips(null, "glow_berry_cream_frosting_ingredient", "berry_ingredient"));
    ...
    public static final DeferredBlock<Block> MELON_CREAM_CAKE = registerCake("melon_cream_cake", ModItems.MELON_CREAM_CAKE_SLICE, 1, tips(null, "melon_cream_frosting_ingredient"));
    ...
    public static final DeferredBlock<Block> UBE_CREAM_UBE_CAKE = registerCake("ube_cream_ube_cake", ModItems.UBE_CREAM_UBE_CAKE_SLICE, 1, tips("ube", "ube_cream_frosting_ingredient"));
